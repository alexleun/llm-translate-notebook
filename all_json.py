...
def is_good_translation(original, translation):
    ...
    if "翻译非常准确" in response_text.lower() or "是的" in response_text.lower() or "翻译准确" in response_text.lower() or  "yes" in response_text.lower() or  "accurate" in response_text.lower() or "fluent" in response_text.lower():
        return True
    else:
        return False
